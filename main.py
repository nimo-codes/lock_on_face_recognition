...
naman= face_recognition.load_image_file("/Users/jarvis/pymycod/automation/facial_recon/known_ppl/nimo.jpeg")
...
while True:
    ...
    if process_this_frame:
        ...
        for face_encoding in face_encodings:
            ...
            for items in face_names:
                if items == "Unknown":
                        print("Get away!!!")
                        playsound("/Users/jarvis/pymycod/automation/sbeep.mp3")
